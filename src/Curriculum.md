...
This guide walks teachers through the curriculum of teaching how to make a multi-user application through CSC.

No prior coding knowledge is required for either of the teacher and the students.
...
<!-- ------------------------------------------------------------------------------------------------------------------------------------------------------- -->
## Curriculum
This curriculum includes teaching materials for five steps,
two challenges (in the first and third steps),
and a quiz (in the fifth step) consisting of multiple-choice questions.
The hoped-for learning outcome of this curriculum is for students to achieve the first
three levels of Bloom’s Taxonomy (Remember, Understand, and Apply). 
...
please ask them to design the CSC of the *Hiking Game*.
...
CSC of that game out of four different CSCs. This challenge measures how
