...
Fo more details about CSC and CSCDraw please refer to (citation removed for review.)
...
The [Party Game](PartyGame\PartyGame.json) can be found [game removed for review.]
...
The [Lights game](LightsGame\LightsGameCSC.json) can be found [game removed for review.]
